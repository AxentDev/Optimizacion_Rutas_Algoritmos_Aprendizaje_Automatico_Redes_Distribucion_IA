# -*- coding: utf-8 -*-
"""
Created on Sun Dec  1 19:08:04 2024
...
# Distancias entre ciudades en kilometros por carretera
distancias = {
...
# Heurística aproximada (distancia euclidea desde Bogotá)
heuristica = {
    'Arauca': 735,'Barranquilla': 640,'Bogotá': 0,'Bucaramanga': 350,'Cali': 440,'Cúcuta': 420,'Ibagué': 191,'Medellín': 240,'Mocoa': 620,'Neiva': 410,'Pasto': 780,'Pereira': 180,'Popayán': 460,'Puerto Carreño': 705,'San José Del Guaviare': 400,'San Vicente Del Caguán': 655,'Tunja': 130,'Villavicencio': 75,'Leticia': 1857,

}

# Algoritmo A*
def busqueda_a_star(inicio, objetivo):
    # (costo total, ciudad, distancia acumulada)
    frontera = [(0 + heuristica[inicio], inicio, 0)]  
    visitados = set()
